...
public abstract class AbstractUserServiceTest extends AbstractServiceTest {
    ...
    public void setup() {
        ...
        if (isProfileJpaOrDataJpa()) {
            jpaUtil.clear2ndLevelHibernateCache();
        }
    }

    private boolean isProfileJpaOrDataJpa() {
        return Arrays.stream(env.getActiveProfiles()).anyMatch(s -> s.equals(Profiles.DATAJPA) ||s.equals(Profiles.JPA) );
    }
    ...
    public void createWithException() {
        Assume.assumeTrue(isProfileJpaOrDataJpa());
